// tinymce.PluginManager.add('placeholder',)
export default function(editor) {
  const Label = function() {
    const placeholder_text = editor.getElement().getAttribute('placeholder') || editor.settings.placeholder
    const placeholder_attrs = editor.settings.placeholder_attrs || { style: { position: 'absolute', top: '5px', left: 0, color: '#888', padding: '1%', width: '98%', overflow: 'hidden', 'white-space': 'pre-wrap' }}
